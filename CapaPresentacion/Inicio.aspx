<%@ Page EnableEventValidation="false"  Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="CapaPresentacion.Inicio" %>
        ...
        <div>
            ...
            <div>
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <asp:GridView ID="GridViewUsuarios" runat="server" CssClass="table table-bordered table-light table-hover" OnRowDataBound="GridViewUsuarios_RowDataBound" OnSelectedIndexChanged="GridViewUsuarios_SelectedIndexChanged">
                                <Columns>
