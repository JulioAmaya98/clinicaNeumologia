<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerCompra.aspx.cs" Inherits="CapaPresentacion.Modulos.VerCompra" %>
...
<body onload="onPageLoad()">
    <div style="padding: 40px">
        ...
        <form style="bottom: 0" id="form1" runat="server">
            ...
            <asp:Button ID="Regresar" runat="server" Text="Regresar" Style="float: right; border-color: gray; color: gray;" class="btn btn"  />
            ...
            <div class="text-lef" style="width: 100%;">
                ...
                <div class="text-lef" style="width: 100%;">
                    <div class="row">
                        ...
                        <div class="col">
                            <asp:DropDownList CssClass="btn btnl" ID="DropDownList2"  AutoPostBack="True" runat="server"></asp:DropDownList>
                        </div>
            ...
            <div style="width: 100%;">
                ...
                <asp:GridView AutoGenerateColumns="false" AllowPaging="false" ID="GridView1" runat="server" CssClass="table  table-hover  myGridView" HorizontalAlign="Justify" >
            ...
            <asp:Button ID="btnImprimir" runat="server" Text="Imprimir" class="btn btn-success btnG" OnClick="btnImprimir_Click" />
        </form>
