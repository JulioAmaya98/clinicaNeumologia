<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductosSecretaria.aspx.cs" Inherits="CapaPresentacion.ProductosSecretaria" %>
...
<body>
    ...
    <div class="container mt-3">
        <ul class="nav nav-tabs justify-content-end " role="tablist">
            <li class="nav-item">
                <a class="nav-link " href="InicioSec.html">Inicio</a>
            </li>
            <li class="nav-item">
